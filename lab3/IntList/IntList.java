...
public class IntList {
    ...
    public static IntList catenate(IntList A, IntList B) {
        ...
        IntList alt = new IntList(A.head,null);
        IntList alt2 = alt;
        IntList copy = new IntList(A.head,A.tail);
        copy = copy.tail;
        while (copy != null) {
            alt.tail = new IntList(copy.head, null);
            copy = copy.tail;
            alt = alt.tail;
        }
        alt.tail = B;
    ...
    public static IntList reverse(IntList A){
        IntList dummy = A;
        IntList nextToAdd = new IntList(dummy.head,null);
        while (dummy.tail != null){
            IntList next = new IntList(dummy.tail.head,nextToAdd);
            nextToAdd = next;
            dummy = dummy.tail;
            A = next;
        }
